...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.onixd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    isorc20Transfer: transaction.isorc20Transfer,
  };
...
TxController.prototype.transformOnixTransaction = function(transaction) {
